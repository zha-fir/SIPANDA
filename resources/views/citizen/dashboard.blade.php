    ...
    <div class="col-12 mb-4">
        <div class="card text-white shadow-lg border-0" 
            ...
            <div class="card-body p-5 position-relative overflow-hidden">
                ...
                <div style="position: absolute; bottom: -40px; right: 50px; width: 100px; height: 100px; background: rgba(255,255,255,0.1); border-radius: 50%;"></div>

                <h2 class="fw-bold">Halo, {{ $warga->nama_lengkap }}! 👋</h2>
                <p class="lead mb-4" style="opacity: 0.9;">Selamat datang di SIPANDA, Sistem Pelayanan Administrasi Desa Panggulo.</p>
                <a href="{{ route('warga.ajuan.create') }}" class="btn btn-light text-primary fw-bold px-4 py-2 shadow-sm">
