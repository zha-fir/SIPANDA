    ...
    <div class="card shadow mb-4">
        ...
        <div class="card-body">
            ...
            <p class="text-danger font-weight-bold">
                PENTING: Pastikan data **Nomor KK** yang Anda masukkan di Excel sudah terdaftar di sistem (di menu Manajemen
                KK) sebelum Anda mengimpor data warga.
            </p>
            ...
            <ol class="mt-2">
                ...
                <li class="text-primary font-weight-bold">**STATUS_HUBUNGAN** (Isi: KEPALA KELUARGA, ISTRI, ANAK, atau
                    FAMILI LAIN)</li>
                <li>**TEMPAT_LAHIR**</li>
            ...
            <p>Sistem akan **otomatis membuatkan akun login** untuk setiap warga dengan **Username = NIK** dan **Password
                Default = 123456**.</p>
